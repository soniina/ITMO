 ...
 * @group Components
 */
export declare class SpeedDial extends BaseComponent implements AfterViewInit, OnDestroy {
    /**
     * List of items id.
     * @group Props
     */
