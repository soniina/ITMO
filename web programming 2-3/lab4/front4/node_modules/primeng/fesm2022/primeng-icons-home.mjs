...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HomeIcon, [{
        type: Component,
        args: [{
                selector: 'HomeIcon',
                standalone: true,
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(HomeIcon, { className: "HomeIcon" }); })();
