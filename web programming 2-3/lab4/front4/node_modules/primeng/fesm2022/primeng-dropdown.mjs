...
import { Injectable, forwardRef, EventEmitter, booleanAttribute, numberAttribute, Component, Input, Output, inject, signal, computed, effect, ChangeDetectionStrategy, ViewEncapsulation, ViewChild, HostBinding, NgModule } from '@angular/core';
...
class Dropdown extends BaseComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: Dropdown, selectors: [["p-dropdown"]], viewQuery: function Dropdown_Query(rf, ctx) { if (rf & 1) {
