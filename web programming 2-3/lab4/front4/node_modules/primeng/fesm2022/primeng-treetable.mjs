...
import { Injectable, inject, EventEmitter, NgZone, booleanAttribute, numberAttribute, Component, ViewEncapsulation, Input, Output, ViewChild, PLATFORM_ID, Inject, Directive, HostListener, ChangeDetectionStrategy, NgModule } from '@angular/core';
...
class TreeTable extends BaseComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeTable, selectors: [["p-treeTable"], ["p-treetable"], ["p-tree-table"]], viewQuery: function TreeTable_Query(rf, ctx) { if (rf & 1) {
...
class TreeTableCellEditor extends BaseComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeTableCellEditor, selectors: [["p-treeTableCellEditor"], ["p-treetablecelleditor"], ["p-treetable-cell-editor"]], features: [i0.ɵɵInheritDefinitionFeature], decls: 2, vars: 2, consts: [[4, "ngIf"], [4, "ngTemplateOutlet"]], template: function TreeTableCellEditor_Template(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TreeTableCellEditor, [{
    ...
    }], () => [{ type: TreeTable }, { type: TTEditableColumn }], null); })();
