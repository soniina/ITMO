...
import { Injectable, EventEmitter, forwardRef, booleanAttribute, numberAttribute, Component, ViewEncapsulation, Inject, Input, Output, ViewChild, signal, inject, effect, ChangeDetectionStrategy, ContentChild, NgModule } from '@angular/core';
...
function ContextMenuSub_ul_0_ng_template_2_li_1_ng_container_3_a_1_ng_container_6_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngIf", !ctx_r2.contextMenu.submenuicon);
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngTemplateOutlet", ctx_r2.contextMenu.submenuicon)("ngTemplateOutletContext", i0.ɵɵpureFunction0(3, _c3));
} }
...
class ContextMenu extends BaseComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ContextMenu, selectors: [["p-contextMenu"], ["p-contextmenu"], ["p-context-menu"]], contentQueries: function ContextMenu_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.submenuicon = _t.first);
