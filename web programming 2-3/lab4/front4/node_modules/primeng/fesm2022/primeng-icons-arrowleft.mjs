...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ArrowLeftIcon, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ArrowLeftIcon, { className: "ArrowLeftIcon" }); })();
